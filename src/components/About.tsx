      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center mb-12 sm:mb-16 md:mb-20">
            ...
            <div className="bg-slate-900/70 backdrop-blur-md border border-blue-500/30 p-7 sm:p-8 md:p-9 shadow-lg shadow-blue-500/10 rounded-lg">
              <h3 className="text-2xl sm:text-3xl md:text-4xl mb-7 sm:mb-8 md:mb-9 text-blue-400 font-mono">
                {'> PROFILE.exe'}
              </h3>
              <div className="space-y-4 sm:space-y-5 text-blue-200 font-mono text-base sm:text-lg leading-relaxed">
                <p>
              ...
              <div className="mt-8 sm:mt-10 pt-6 sm:pt-7 border-t border-blue-500/30">
                <h4 className="text-xl mb-4 sm:mb-5 text-blue-400 font-mono">{'> EDUCATION'}</h4>
                <div className="space-y-3 sm:space-y-3.5 text-blue-200 font-mono text-sm sm:text-base">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-7 md:gap-8">
            <div className="p-6 sm:p-7 md:p-8 bg-slate-900/70 backdrop-blur-md border border-blue-500/30 hover:border-blue-400 active:border-blue-400 transition-all group shadow-lg shadow-blue-500/10 touch-manipulation rounded-lg">
              <div className="w-12 h-12 sm:w-14 sm:h-14 border border-blue-500 flex items-center justify-center mb-5 sm:mb-6 group-hover:bg-blue-500/20 transition-all">
                <Terminal className="text-blue-400" size={28} />
              </div>
              <h4 className="text-lg sm:text-xl mb-4 sm:mb-5 text-blue-400 font-mono">{'> PENTESTING'}</h4>
            ...
            <div className="p-6 sm:p-7 md:p-8 bg-slate-900/70 backdrop-blur-md border border-blue-500/30 hover:border-blue-400 active:border-blue-400 transition-all group shadow-lg shadow-blue-500/10 rounded-lg">
              <div className="w-12 h-12 sm:w-14 sm:h-14 border border-blue-500 flex items-center justify-center mb-5 sm:mb-6 group-hover:bg-blue-500/20 transition-all">
                <Shield className="text-blue-400" size={28} />
              </div>
              <h4 className="text-lg sm:text-xl mb-4 sm:mb-5 text-blue-400 font-mono">{'> THREAT_INTEL'}</h4>
              <p className="text-blue-200 font-mono text-sm sm:text-base leading-relaxed">
            ...
            <div className="p-6 sm:p-7 md:p-8 bg-slate-900/70 backdrop-blur-md border border-blue-500/30 hover:border-blue-400 active:border-blue-400 transition-all group shadow-lg shadow-blue-500/10 rounded-lg">
              ...
              <h4 className="text-lg sm:text-xl mb-4 sm:mb-5 text-blue-400 font-mono">{'> CLOUD_SECURITY'}</h4>
              <p className="text-blue-200 font-mono text-sm sm:text-base leading-relaxed">
